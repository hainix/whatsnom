...
$PHPTHUMB_CONFIG['cache_maxage'] = 86400 * 3;        // delete cached thumbnails that haven't been accessed in more than [30 days] (value is maximum time since last access in seconds to avoid deletion)
...
// force allowing resizing of images
$PHPTHUMB_CONFIG['output_allow_enlarging'] = 1;
...
$PHPTHUMB_CONFIG['error_message_image_default'] = '/images/defaults/film.jpg';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
