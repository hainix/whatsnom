(function($) {
    ...
    // navigation
  function allinone_bannerWithPlaylist_navigation(direction,current_obj,options,total_images,thumbsHolder_Thumbs,allinone_bannerWithPlaylist_container,thumbsHolder_Thumb,thumbMarginTop,allinone_bannerWithPlaylist_thumbsHolder,allinone_bannerWithPlaylist_sliderVertical,imgs, was_click) {
      ...
      // If clicks are forced to go to pages, then go there yo
      if (was_click && options.clicksGoToPage) {
          var redirection_url = current_obj.currentImg.attr('data-url');
          if (redirection_url) {
	...
	$.fn.allinone_bannerWithPlaylist = function(options) {
		...
		return this.each(function() {
			...
			var bannerControls = jQuery('<div class="bannerControls">   <div class="leftNav"></div>   <div class="rightNav"></div>    <div class="thumbsHolderWrapper"><div class="thumbsHolderVisibleHeader"><b></b><div class="thumbsHolderVisibleHeaderLeft">New Movies</div></div><div class="thumbsHolderVisibleWrapper"><div class="thumbsHolder"></div></div></div>  <div class="slider-vertical"></div>     </div>');
			...
			//allinone_bannerWithPlaylist_thumbsHolderVisibleWrapper.css('top', 20);
			...
			imgs.each(function() {
	            ...
	            if(current_obj.currentImg.is('img')){
					...
					image_name =
              current_obj.currentImg.attr('src').substr(current_obj.currentImg.attr('src').lastIndexOf('/'),current_obj.currentImg.attr('src').length);
					thumbUnit='';
					if (options.showThumbs)
            var thumb_src = current_obj.currentImg.attr('data-thumb-src');
						thumbUnit='<img src="'+ thumb_src + '" class="thumb_image" width="45" height="45">';
        ...
        allinone_bannerWithPlaylist_sliderVertical.height(allinone_bannerWithPlaylist_thumbsHolderWrapper.height()-45); // 25 is the height of  .slider-vertical.ui-slider .ui-slider-handle
      ...
      /*
			...
			allinone_bannerWithPlaylist_container.click(function() {
              document.location.href = 'http://dishoomfilms.com/tv';
              return false;
              //alert("a");
      ...
      */
			...
			allinone_bannerWithPlaylist_leftNav.click(function() {
				if (!current_obj.effectIsRunning) {
					//mouseOverBanner=false;
					clearTimeout(timeoutID);
					allinone_bannerWithPlaylist_navigation(-1,current_obj,options,total_images,thumbsHolder_Thumbs,allinone_bannerWithPlaylist_container,thumbsHolder_Thumb,thumbMarginTop,allinone_bannerWithPlaylist_thumbsHolder,allinone_bannerWithPlaylist_sliderVertical,imgs, false);
				}
			});
			...
			thumbsHolder_Thumbs.click(function() {
				if (!current_obj.effectIsRunning) {
					...
					allinone_bannerWithPlaylist_navigation(1,current_obj,options,total_images,thumbsHolder_Thumbs,allinone_bannerWithPlaylist_container,thumbsHolder_Thumb,thumbMarginTop,allinone_bannerWithPlaylist_thumbsHolder,allinone_bannerWithPlaylist_sliderVertical,imgs, true);
